...
export function Shop({ items }: { items: products.Product[] }) {
  return (
    <div className="mx-auto">
      <div
        className="bg-black text-custom-1 text-center py-4 sm:py-20 h-[450px] sm:h-[520px]"
      ...
      >
        ...
        <p className="text-sm sm:text-base mx-auto px-8 sm:max-w-[50%] my-10">
          All the latest merch from our store for USA tours and events.
        </p>
      </div>
      {items.length ? (
        <div
              ...
              >
                ...
                {!item.manageVariants && item.stock?.inStock ? (
                  <a
                    ...
                    className="btn-main absolute left-0 -top-10 cursor-pointer"
